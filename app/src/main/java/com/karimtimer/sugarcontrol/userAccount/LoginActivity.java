...
public class LoginActivity extends AppCompatActivity {
    ...
    private Button btnSignup, btnLogin, btnReset, btnForgtPassword;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnForgtPassword = findViewById(R.id.btn_to_the_forgot_password_screen);
        ...
        btnForgtPassword.setOnClickListener(new View.OnClickListener() {
            @Override
