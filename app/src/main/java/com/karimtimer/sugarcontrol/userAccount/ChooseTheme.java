...
public class ChooseTheme extends AppCompatActivity {
   ...
   protected void onCreate(Bundle savedInstanceState){
      ...
      setContentView(R.layout.fragment_choose_theme);


      final Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar_done);
      ...
      button.setOnClickListener(new View.OnClickListener(){
         ...
         public void onClick(View v){
            ColorChooserDialog dialog = new ColorChooserDialog(ChooseTheme.this);
